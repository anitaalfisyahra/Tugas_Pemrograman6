...
namespace P6_2_1204014
{
    public partial class Form1 : Form
    {
        private string url = "server=localhost;userid=root;password=;database=p6_1204014";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string url = "server=localhost;userid=root;password=;database=p6_1204014";
            string myConnectionString = "integrated security=true;datasource=localhost;initial catalog=p6_1204014";
            MySqlConnection conn = new MySqlConnection(url);
